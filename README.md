...
│   └── gru_model.keras       # Pre-trained GRU model for traffic analysis
├── frontend/
│   ├── index.html            # Dashboard UI (HTML/Tailwind/JS)
│   └── icons/                # UI icons and assets
├── notebooks/
│   ├── cleaning_eda.ipynb    # Data preprocessing & exploratory analysis
│   └── model_training.ipynb  # GRU model architecture and training logic
├── data/
│   ├── raw/                  # Original CICIDS2017 datasets (8 files)
│   └── cleaned/              # Processed data for simulation and training
